...
pub fn shell_impl(shell: &[String], cmd: &str, input: Option<Rope>) -> anyhow::Result<Tendril> {
    tokio::task::block_in_place(|| helix_lsp::block_on(shell_impl_async(shell, cmd, input)))
}

pub async fn shell_impl_async(
    shell: &[String],
    cmd: &str,
    input: Option<Rope>,
...
pub fn shell(cx: &mut compositor::Context, cmd: &str, behavior: &ShellBehavior) {
...
pub fn shell_prompt<F>(cx: &mut Context, prompt: Cow<'static, str>, mut callback_fn: F)
where
...
pub fn shell_prompt_for_behavior(cx: &mut Context, prompt: Cow<'static, str>, behavior: ShellBehavior) {
