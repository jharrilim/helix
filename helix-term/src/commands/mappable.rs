...
impl MappableCommand {
    ...
    static_commands!(
        ...
        plan_panel_page_up, "Scroll plan panel up",
        plan_panel_page_down, "Scroll plan panel down",
        plan_panel_activate, "Activate focused plan panel action",
        plan_panel_close, "Close plan panel",
        plan_panel_focus_agent, "Focus agent panel from plan panel",
        review_toggle, "Toggle code review mode",
        review_comment, "Add review comment on cursor line",
        review_submit, "Submit review to agent",
        review_new, "Start new code review session",
        review_list, "List saved code reviews",
        review_summary, "Set review summary text",
        review_next, "Jump to next review comment",
        review_prev, "Jump to previous review comment",
        review_panel_toggle, "Toggle code review panel",
        review_panel_move_down, "Move review panel selection down",
        review_panel_move_up, "Move review panel selection up",
        review_panel_activate, "Open selected review or comment",
        review_panel_delete, "Delete selected review or comment",
        review_panel_submit, "Submit active review to agent",
        review_panel_refresh, "Refresh review panel list",
        review_panel_close, "Close review panel",
