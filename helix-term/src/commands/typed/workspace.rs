...
pub(crate) fn change_current_directory(
...
pub(crate) fn show_directory_stack(
    cx: &mut compositor::Context,
    _args: Args,
    event: PromptEvent,
) -> anyhow::Result<()> {
...
pub(crate) fn show_current_directory(
    cx: &mut compositor::Context,
    _args: Args,
    event: PromptEvent,
) -> anyhow::Result<()> {
...
pub(crate) fn untrust_workspace(
